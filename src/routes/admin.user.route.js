...
router.get('/admin/users', isLoggedIn, controller.List)
router.get('/admin/users/edit/:id', isLoggedIn, controller.RenderEditUser)
router.post('/admin/users/edit/:id', isLoggedIn, controller.EditUser)
router.get('/admin/users/delete/:id', isLoggedIn, controller.DeleteUser)
